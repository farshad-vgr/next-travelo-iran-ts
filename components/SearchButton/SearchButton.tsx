	...
	return (
		<>
			<div
				...
				className={`absolute top-3 right-5 ${elementWidth} h-10 mt-1 px-2 rounded-full text-base bg-red-500 text-white hover:bg-red-600 hover:cursor-pointer transition-all duration-700`}>
				{elementWidth === "w-80" ? (
					<input
